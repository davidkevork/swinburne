...
float FindSalary(struct Emp x[],char p[], int n);
...
int main(int argc, char const *argv[])
{
    ...
    printf("Enter the name of the employee you want to find the salary: ");
    char p[24];
    scanf("%s", p);
    printf("Salary for employee %s is %f\n", p, FindSalary(a, p, n));
