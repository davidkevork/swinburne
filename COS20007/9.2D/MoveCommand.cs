...
namespace SwinAdventure.src
{
    public class MoveCommand : Command
    {
        ...
        {
            string data = "[move] Usage: move <up/down/left/right>\n";
            data += "[head] Usage: head <north/south/east/west/northeast/northwest/southeast/southwest>\n";
            data += "[go] \tUsage: head <north/south/east/west/northeast/northwest/southeast/southwest>\n";
            data += "[leave]\n";
            return data;
        }
    }
